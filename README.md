...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7730&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pg8000-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pg8000` can be installed with `conda`:
...
```
mamba install pg8000
```

It is possible to list all of the versions of `pg8000` available on your platform with `conda`:
...
```
mamba search pg8000 --channel conda-forge
```
...
mamba repoquery search pg8000 --channel conda-forge

# List packages depending on `pg8000`:
mamba repoquery whoneeds pg8000 --channel conda-forge

# List dependencies of `pg8000`:
mamba repoquery depends pg8000 --channel conda-forge
```
